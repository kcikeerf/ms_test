...
// 配置CDN
let cdnPublicPath = `http://cdn.k12ke.com/zx-wx/zx-wlxx/00016110/${paths.currentDate}/`;
...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            ...
            chunksSortMode: function (a, b) {
                let order = ['manifest', 'common', 'vendor-question', 'zxSurveyQuestion'];
                return order.indexOf(a.names[0]) - order.indexOf(b.names[0]);
            }
        }),
        ...
        new HtmlWebpackPlugin({
            inject: true,
            template: paths.zxSurveyLyQuestion.htmlTemplate,
            filename: paths.zxSurveyLyQuestion.htmlOutput,
